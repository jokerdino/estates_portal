"""
Django settings for estatesportal project.
...
INSTALLED_APPS = [
    ...
    "django_tables2",
    "debug_toolbar",
    "lease_application.apps.LeaseApplicationConfig",
    "accounts",
]
...
ROOT_URLCONF = "estatesportal.urls"
...
WSGI_APPLICATION = "estatesportal.wsgi.application"
...
LOGIN_REDIRECT_URL = reverse_lazy("lease_list")
